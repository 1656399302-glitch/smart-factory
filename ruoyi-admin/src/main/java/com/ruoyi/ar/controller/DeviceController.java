...
public class DeviceController extends BaseController
{
     ...
     * 查询设备列表
     */
    @PreAuthorize("@ss.hasPermi('ar:device:list')")
    @GetMapping("/list")
     ...
     * 导出设备列表
     */
    @PreAuthorize("@ss.hasPermi('ar:device:export')")
     ...
     * 获取设备详细信息
     */
    @PreAuthorize("@ss.hasPermi('ar:device:query')")
     ...
     * 新增设备
     */
    @PreAuthorize("@ss.hasPermi('ar:device:add')")
     ...
     * 修改设备
     */
    @PreAuthorize("@ss.hasPermi('ar:device:edit')")
     ...
     * 删除设备
     */
    @PreAuthorize("@ss.hasPermi('ar:device:remove')")
