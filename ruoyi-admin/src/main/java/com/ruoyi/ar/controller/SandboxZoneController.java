...
public class SandboxZoneController extends BaseController
{
     ...
     * 查询沙盘分区列表
     */
    @PreAuthorize("@ss.hasPermi('ar:zone:list')")
    @GetMapping("/list")
     ...
     * 导出沙盘分区列表
     */
    @PreAuthorize("@ss.hasPermi('ar:zone:export')")
     ...
     * 获取沙盘分区详细信息
     */
    @PreAuthorize("@ss.hasPermi('ar:zone:query')")
     ...
     * 新增沙盘分区
     */
    @PreAuthorize("@ss.hasPermi('ar:zone:add')")
     ...
     * 修改沙盘分区
     */
    @PreAuthorize("@ss.hasPermi('ar:zone:edit')")
     ...
     * 删除沙盘分区
     */
    @PreAuthorize("@ss.hasPermi('ar:zone:remove')")
