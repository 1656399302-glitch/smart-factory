...
public class FactoryController extends BaseController
{
     ...
     * 查询工厂列表
     */
    @PreAuthorize("@ss.hasPermi('ar:factory:list')")
    @GetMapping("/list")
     ...
     * 导出工厂列表
     */
    @PreAuthorize("@ss.hasPermi('ar:factory:export')")
     ...
     * 获取工厂详细信息
     */
    @PreAuthorize("@ss.hasPermi('ar:factory:query')")
     ...
     * 新增工厂
     */
    @PreAuthorize("@ss.hasPermi('ar:factory:add')")
     ...
     * 修改工厂
     */
    @PreAuthorize("@ss.hasPermi('ar:factory:edit')")
     ...
     * 删除工厂
     */
    @PreAuthorize("@ss.hasPermi('ar:factory:remove')")
