...
import com.ruoyi.vr.domain.Work;
import com.ruoyi.vr.service.IWorkService;
...
public class WorkController extends BaseController
{
     ...
     * 查询作品列表
     */
    @PreAuthorize("@ss.hasPermi('vr:work:list')")
    @GetMapping("/list")
     ...
     * 导出作品列表
     */
    @PreAuthorize("@ss.hasPermi('vr:work:export')")
     ...
     * 获取作品详细信息
     */
    @PreAuthorize("@ss.hasPermi('vr:work:query')")
     ...
     * 新增作品
     */
    @PreAuthorize("@ss.hasPermi('vr:work:add')")
     ...
     * 修改作品
     */
    @PreAuthorize("@ss.hasPermi('vr:work:edit')")
     ...
     * 删除作品
     */
    @PreAuthorize("@ss.hasPermi('vr:work:remove')")
