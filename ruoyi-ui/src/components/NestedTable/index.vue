              ...
              >
                <template slot-scope="subScope">
                  <template v-if="col.render">
                    ...
                    />
                    <!-- <RenderVnode :vNode="createComponent(col, subScope.row)" /> -->
                  </template>
          ...
          <template slot-scope="scope">
            <template v-if="col.render">
              <component
                ...
                v-on="col.render.events"
              />
              <!-- <RenderVnode :vNode="createComponent(col, scope.row)" /> -->
            </template>
...
export default {
  ...
  methods: {
    createComponent(col, row) {
      console.log(col, row, "col, row");
      return this.$createElement(col.render.component, {
        props: col.render.props(row),
        on: col.render.events,
      });
    },
