<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="指导教师" align="center" prop="instructor" />
      <el-table-column label="获奖情况" align="center" prop="awardInfo" />
      <el-table-column
        label="简介"
        align="center"
        prop="description"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="指导教师" prop="instructor">
          <el-input v-model="form.instructor" placeholder="请输入指导教师" />
        </el-form-item>
        <el-form-item label="获奖情况" prop="awardInfo">
          <el-input
            v-model="form.awardInfo"
            type="textarea"
            placeholder="请输入内容"
          />
        </el-form-item>
...
<script>
import { listWork, getWork, delWork, addWork, updateWork } from "@/api/vr/work";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除作品编号为"' + workIds + '"的数据项？')
        .then(function () {
